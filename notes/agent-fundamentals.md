...
## LLM
A type of artificial intelligence program trained on massive amounts of text data to understand, summarize, translate, and generate human-like language

## Workflow
A structured sequence of steps used to complete tasks

## AI Agent
A system that autonomously performs tasks by designing workflows via instructions, context or available tools
